...
def train(data, train_idx, val_idx, test_idx,model,num_epochs,lr,weight_decay,logger,model_file):
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        if loss_val < min_loss:
            ...
            torch.save(model.state_dict(),"/BotSim-24-Exp//BestModel/{}.pth".format(model_file))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default='/BotSim-24-Exp//Log/rgcn_log.log', help='dir of logger')
