...
class RGT(nn.Module):
    def __init__(self,value_num, text_num,feature_dim,classes,dropout,data,num_layers):
        ...
        self.RGT_layer1 = RGTLayer(num_edge_type=3,
                                   in_channel=feature_dim,
                                   trans_heads=4,
                                   semantic_head=4,
                                   out_channel=feature_dim,
                                   dropout=0.3)
        self.RGT_layer2 = RGTLayer(num_edge_type=3,
                                   in_channel=feature_dim,
                                   trans_heads=4,
                                   semantic_head=4,
                                   out_channel=feature_dim,
    ...
    def forward(self,value_feature, text_feature,edge_index, edge_type, idx):
        ...
        feature = self.RGT_layer1(feature, edge_index=edge_index, edge_type = edge_type)     
        feature = self.RGT_layer2(feature, edge_index=edge_index, edge_type = edge_type)            
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default='BotSim-24-Exp/Method/BestModel/rgt_log.log', help='dir of logger')
    ...
    for i,seed in enumerate(args.random_seed):
        ...
        model = RGT(args.value_num, args.text_num,args.feature_dim,args.classes,args.dropout,dataloader,args.num_layers)
