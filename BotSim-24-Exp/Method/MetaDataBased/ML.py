...
parser.add_argument('--task', type=str, default='bot', help='detection task of bot')
...
feature = torch.load("BotSim-24-Exp/Dataset/num_properties_tensor.pt")

label = torch.load("BotSim-24-Exp/Dataset/label.pt")
label = label.unsqueeze(1)
data = torch.cat((feature,label), dim = 1)
out_dim = 2
